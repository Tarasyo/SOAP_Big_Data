 ...
 * @author Tarasyo
 */
@WebServlet(name = "NewDollar", urlPatterns = {"/NewDollar"})
public class NewDollar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try { // Call Web Service Operation
            ...
            String input = "";
            java.math.BigDecimal dNum = new java.math.BigDecimal(input);
...
// Now you can access an https URL without having the certificate in the truststore
        ...
        try (PrintWriter out = response.getWriter()) {
          String input = request.getParameter("inputNumber");
            ...
            java.math.BigDecimal send = number;
            
            java.lang.String result = numberToDollars(send);
...
private String numberToDollars(java.math.BigDecimal dNum) {
